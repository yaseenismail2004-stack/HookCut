...
class Settings(BaseSettings):
    ...
    gemini_clip_analysis_model: str = "gemini-3.6-flash"
    gemini_clip_analysis_request_timeout_seconds: PositiveInt = 300
    gemini_clip_analysis_max_requests: PositiveInt = 1
    gemini_clip_analysis_max_candidates_per_request: PositiveInt = 12
    gemini_clip_analysis_max_transcript_chars_per_candidate: PositiveInt = 600
    gemini_clip_analysis_max_detected_weaknesses: PositiveInt = 4
    gemini_clip_analysis_max_topic_chars: PositiveInt = 60
    gemini_clip_analysis_max_analysis_note_chars: PositiveInt = 180
    gemini_clip_analysis_max_title_chars: PositiveInt = 100
    gemini_clip_analysis_max_hook_chars: PositiveInt = 120
    gemini_clip_analysis_max_request_chars: PositiveInt = 18000
    gemini_clip_analysis_max_expected_response_chars: PositiveInt = 10000
    gemini_clip_analysis_max_output_tokens: PositiveInt = 8192
